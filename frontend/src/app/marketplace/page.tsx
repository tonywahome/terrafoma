...
export default function MarketplacePage() {
  ...
  const getQualityTier = (credit: CarbonCredit) => {
    ...
    if (credit.integrity_score >= 75 && credit.risk_score < 0.30)
  ...
  const filteredCredits = credits.filter((c) => {
    ...
    if (filter === "premium") return tier.label === "Premium" || tier.label === "High Quality";
          ...
          {filteredCredits.map((credit) => {
            ...
            >
              ...
              <div className="p-5 space-y-4">
                ...
                {/* Risk Score */}
                <RiskGauge score={credit.risk_score} label="Risk Assessment" />
                ...
                <div className="border-t pt-3">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-2xl font-bold text-gray-900">
                      $
                      {(credit.price_per_tonne * credit.quantity_tco2e).toFixed(
                        2
                      )}
                    </span>
                  </div>
      ...
      <div className="mt-12 bg-gradient-to-r from-terra-50 to-green-50 rounded-xl p-8 border border-terra-200">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Nature-based carbon sequestration from verified forest conservation
              and restoration projects across Kenya.
            </p>
          </div>
        </div>
      </div>
